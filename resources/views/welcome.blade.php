...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <link rel="manifest" href="{{url('web/assets/img/favicons/manifest.json')}}">
    <meta name="msapplication-TileImage" content="{{url('web/assets/img/favicons/mstile-150x150.png')}}">
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link href="{{url('web/assets/css/theme.css')}}" rel="stylesheet" />
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="#"><img src="{{url('web/assets/img/icons/logo.png')}}" alt="" width="30" /><span class="text-1000 fs-1 ms-2 fw-medium"><span class="fw-bold">{{Nfs::app()}}</span></span></a>
        ...
        <div class="container">
          <div class="row flex-center">
            ...
            <div class="col-md-7 col-lg-6 mt-5 text-center text-md-start">
              ...
              <p class="mt-3 mb-4">Provide a network for all your needs with ease and fun using <span class="fw-medium">{{Nfs::app()}} </span>discover interesting features from us.Most people make the mistake of forcing themselves to network.Or they pretend to be outgoing to make new connections. </p><a class="btn btn-lg btn-danger hover-top btn-glow" href="#">Get Started </a>
            </div>
          </div>
        </div>
        <!-- end of .container-->
            ...
            <div class="col-md-4 pt-4 px-md-2 px-lg-3">
              <div class="card h-100">
                <div class="card-body d-flex flex-column justify-content-around mx-auto">
                  <div class="text-center pt-5"><img class="img-fluid" src="{{url('web/assets/img/icons/pricing.png')}}" alt="" />
      ...
      <section class="bg-100 py-7 text-center">
        ...
        <div class="container">
          <div class="row justify-content-center">
            ...
            <div class="pt-8"><img class="img-fluid" src="{{url('web/assets/img/gallery/map.png')}}" alt="" /></div>
          </div>
        </div>
        <!-- end of .container-->
      ...
      <section class="py-5 bg-100">
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0"><img class="img-fluid" src="{{url('web/assets/img/gallery/netflix.png')}}" alt="" height="50" /></div>
            <div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0"><img class="img-fluid" src="{{url('web/assets/img/gallery/reddit.png')}}" alt="" height="50" /></div>
            <div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0"><img class="img-fluid" src="{{url('web/assets/img/gallery/amazon.png')}}" alt="" height="50" /></div>
            <div class="col-6 col-sm-4 col-md-2 mb-2 mb-sm-0"><img class="img-fluid" src="{{url('web/assets/img/gallery/discord.png')}}" alt="" height="50" /></div>
            <div class="col-6 col-sm-4 col-md-2 mb-2 mb-sm-0"><img class="img-fluid" src="{{url('web/assets/img/gallery/spotify.png')}}" alt="" height="50" /></div>
          </div>
        </div>
        <!-- end of .container-->
                ...
                <div class="row h-100">
                    ...
                    <div class="card h-100">
                      <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                          <div class="d-flex align-items-center"><img class="img-fluid" src="{{url('web/assets/img/gallery/user-1.png')}}" alt="" />
                  ...
                  <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card h-100">
                      <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                          <div class="d-flex align-items-center"><img class="img-fluid" src="{{url('web/assets/img/gallery/user-2.png')}}" alt="" />
                            <div class="flex-1 ms-3">
                  ...
                  <div class="col-md-4 mb-3 mb-md-0">
                    <div class="card h-100">
                      <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                          <div class="d-flex align-items-center"><img class="img-fluid" src="{{url('web/assets/img/gallery/user-3.png')}}" alt="" />
                            <div class="flex-1 ms-3">
                              <h6 class="mb-0 fs--1 text-1000 fw-medium">Viezh Robert</h6>
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="{{url('web/vendors/@popperjs/popper.min.js')}}"></script>
    <script src="{{url('web/vendors/bootstrap/bootstrap.min.js')}}"></script>
    <script src="{{url('web/vendors/is/is.min.js')}}"></script>
    <script src="{{url('web/https://polyfill.io/v3/polyfill.min.js?features=window.scroll')}}"></script>
